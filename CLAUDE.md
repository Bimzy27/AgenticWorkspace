<!-- This file is kept in sync with AGENTS.md. On Linux/macOS it is a symlink.
     On Windows, run bootstrap\windows.ps1 to create the mklink equivalent.
...
When you encounter a recurring mistake, a platform gotcha, or a pattern worth remembering: update AGENTS.md (not this file). This file is the long-term memory of the workflow. Keep it accurate, keep it concise. If a section becomes stale, remove or rewrite it.
